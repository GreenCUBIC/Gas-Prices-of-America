...
# Example: python random-model-r10.py -i ../../dataverse/sample/sample-imgs/  -o ../yolo-benchmark/random-predictions/r10/random-1.json -v
...
for img in imgs:
    ...
    # Randomly select the number of digits 'detected'
