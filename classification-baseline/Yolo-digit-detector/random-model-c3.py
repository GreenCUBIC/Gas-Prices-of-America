...
# Example: python random-model-c3.py -i ../../dataverse/sample/sample-imgs/  -o ../yolo-benchmark/random-predictions/c3/random-1.json -v
...
for img in imgs:
    ...
    # Randomly select a constant of digits 'detected'
    num_rand = 3
